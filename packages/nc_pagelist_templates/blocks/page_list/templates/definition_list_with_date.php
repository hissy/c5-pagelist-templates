<?php
	...
	for ($i = 0; $i < count($cArray); $i++ ) {
		...
		<dt class="ccm-page-list-date-public"><?php echo $cobj->getCollectionDatePublic('Y-m-d') ?></dt>
		<dd class="ccm-page-list-title"><a <?php if ($target != '') { ?> target="<?php echo $target?>" <?php } ?> href="<?php echo $nh->getLinkToCollection($cobj)?>"><?php echo $title?></a></dd>
		<?php if ( "" != $cobj->getCollectionDescription() ) { ?>
		<dd class="ccm-page-list-description">
			<?php
